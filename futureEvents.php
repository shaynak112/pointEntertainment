        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <div id='leftEventTwo'>
                    ...
                    <h3>Toronto's First Silent Party - Friday August 18</h3>

                <div class="newEventsDiv" id="newEvents4">
                    <a href="https://www.facebook.com/events/182077545665841" target="_blank">
                    <img class ="newEventsImg" style='width:80%;' src="futureEvents/silentParty.jpg"></a>
                </div> <!--end of img div-->

                <br/>

                        <div id='infoSilentParty'>
                            <div>For your ears only - Toronto's first Silent party - 3 genres!</div>
                            <br/>
                            <div>As part of the Populus closing month final events - three styles of music (house, techno, trance)</div>
                            <br/>
                            <div>Techno: Quim, Ticky Ty, Peter Zurub, Brian Moar, Thien</div>
                            <div>House: Brendan Williams, Ruznek, Bo Co, Tri-Ohm</div>
                            <br/>
                            <div>Trance: Marshall, HNR Sound, Lucas D'erman</div>
                            <div>Facebook event page is <a href="https://www.facebook.com/events/182077545665841" target="_blank">HERE.</a> $10 all night to cover the cost of the headphones. No guestlist!</div>
                        </div><!--end info silent party-->
